...
export const metadata: Metadata = {
    ...
    openGraph:{
        type:"website",
        url:"https://store.istad.co/policy",
...
export default function PolicyPage() {
    return (
        <main className='container mx-auto mt-20 px-4 sm:px-6 lg:px-8 mb-5'>
            ...
            <ul className='list-disc pl-5'>
                ...
                <li className='mt-10'>
                    ...
                    <p className='leading-7'>We offer free shipping on all orders over $50. Orders are typically
                        processed within 1-2 business days and delivered within 5-7 business days. Please note that
                ...
                <li className='mt-10'>
                    ...
                    <p className='leading-7'>We value your privacy and are committed to protecting your personal
                        information. We only collect information necessary to process your order and do not share this
                ...
                <li className='mt-10'>
                    ...
                    <p className='leading-7'>By using our services, you agree to our terms of service. We reserve the
                        right to change these terms at any time, so please review them regularly.</p>
                </li>
                <li className='mt-10'>
                    <h2 className='text-lg sm:text-xl lg:text-2xl font-bold text-black mb-4'>FAQs</h2>
                    <p className='leading-7'>If you have any questions about our policies, please check our FAQs or
